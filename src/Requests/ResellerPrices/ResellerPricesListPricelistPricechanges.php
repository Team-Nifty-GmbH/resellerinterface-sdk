...
/**
 * post_resellerPrices_listPricelistPricechanges
 *
 * Listet Preisänderungen einer Preisliste auf<br /><br />Benötigte Rechte:<br
 * />**Reseller-Preisverwaltung** (api.reseller.prices)<br /><br /><a target="_blank"
 * href="/core/api#resellerPrices/listPricelistPricechanges">In Reseller-Interface öffnen</a>
 */
class ResellerPricesListPricelistPricechanges extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/resellerPrices/listPricelistPricechanges';
    }
}
