...
/**
 * post_resellerPrices_deletePayment
 *
 * <br /><br />Benötigte Rechte:<br />**Reseller-Preisverwaltung** (api.reseller.prices)<br /><br /><a
 * target="_blank" href="/core/api#resellerPrices/deletePayment">In Reseller-Interface öffnen</a>
 */
class ResellerPricesDeletePayment extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/resellerPrices/deletePayment';
    }
}
