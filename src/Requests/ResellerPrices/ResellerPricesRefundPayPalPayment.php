...
/**
 * post_resellerPrices_refundPayPalPayment
 *
 * <br /><br />Benötigte Rechte:<br />**Reseller-Preisverwaltung** (api.reseller.prices)<br /><br /><a
 * target="_blank" href="/core/api#resellerPrices/refundPayPalPayment">In Reseller-Interface
 * öffnen</a>
 */
class ResellerPricesRefundPayPalPayment extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/resellerPrices/refundPayPalPayment';
    }
}
