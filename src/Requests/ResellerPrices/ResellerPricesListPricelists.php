...
/**
 * post_resellerPrices_listPricelists
 *
 * Listet Preislisten auf<br /><br />Benötigte Rechte:<br />**Reseller-Preisverwaltung**
 * (api.reseller.prices)<br /><br /><a target="_blank"
 * href="/core/api#resellerPrices/listPricelists">In Reseller-Interface öffnen</a>
 */
class ResellerPricesListPricelists extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/resellerPrices/listPricelists';
    }
}
