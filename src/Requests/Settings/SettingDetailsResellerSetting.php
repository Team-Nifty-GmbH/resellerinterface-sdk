...
/**
 * post_setting_detailsResellerSetting
 *
 * Detaillierte Informationen zu einer Einstellung<br /><br />Benötigte Rechte:<br />**Unterreseller
 * verwalten** (api.reseller.manage)<br /><br /><a target="_blank"
 * href="/core/api#setting/detailsResellerSetting">In Reseller-Interface öffnen</a>
 */
class SettingDetailsResellerSetting extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/setting/detailsResellerSetting';
    }
}
