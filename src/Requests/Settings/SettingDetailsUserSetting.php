...
/**
 * post_setting_detailsUserSetting
 *
 ...
 * href="/core/api#setting/detailsUserSetting">In Reseller-Interface öffnen</a>
 */
class SettingDetailsUserSetting extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/setting/detailsUserSetting';
    }
}
