...
/**
 * post_webspace_restore
 *
 * Wiederherstellung eines Webspaces<br /><br />Benötigte Rechte:<br />**Webspacepakete kündigen**
 * (api.webspace.delete)<br /><br /><a target="_blank" href="/core/api#webspace/restore">In
 * Reseller-Interface öffnen</a>
 */
class WebspaceRestore extends Request implements HasBody
{
    use HasFormBody;
