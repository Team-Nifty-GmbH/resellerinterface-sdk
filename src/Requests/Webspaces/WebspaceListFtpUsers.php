...
/**
 * post_webspace_listFtpUsers
 *
 * Listet FTP-Benutzer auf<br /><br />Benötigte Rechte:<br />**Webspacepakete einsehen**
 * (api.webspace.view)<br /><br /><a target="_blank" href="/core/api#webspace/listFtpUsers">In
 * Reseller-Interface öffnen</a>
 */
class WebspaceListFtpUsers extends Request implements HasBody
{
    use HasFormBody;
