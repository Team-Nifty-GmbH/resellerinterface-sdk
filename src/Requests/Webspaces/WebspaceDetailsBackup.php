...
/**
 * post_webspace_detailsBackup
 *
 * <br /><br />Benötigte Rechte:<br />**Webspacepakete verwalten** (api.webspace.manage)<br /><br /><a
 * target="_blank" href="/core/api#webspace/detailsBackup">In Reseller-Interface öffnen</a>
 */
class WebspaceDetailsBackup extends Request implements HasBody
{
    use HasFormBody;
