...
/**
 * post_webspace_listDomains
 *
 * Listet vorhandene Domains auf<br /><br />Benötigte Rechte:<br />**Webspacepakete einsehen**
 * (api.webspace.view)<br /><br /><a target="_blank" href="/core/api#webspace/listDomains">In
 * Reseller-Interface öffnen</a>
 */
class WebspaceListDomains extends Request implements HasBody
{
    use HasFormBody;
