...
/**
 * post_webspace_listCronjobs
 *
 * Listet vorhandene Cronjobs auf<br /><br />Benötigte Rechte:<br />**Webspacepakete einsehen**
 * (api.webspace.view)<br /><br /><a target="_blank" href="/core/api#webspace/listCronjobs">In
 * Reseller-Interface öffnen</a>
 */
class WebspaceListCronjobs extends Request implements HasBody
{
    use HasFormBody;
