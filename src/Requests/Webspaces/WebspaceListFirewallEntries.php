...
/**
 * post_webspace_listFirewallEntries
 *
 * Listet Firewall-Freigaben auf<br /><br />Benötigte Rechte:<br />**Webspacepakete einsehen**
 * (api.webspace.view)<br /><br /><a target="_blank" href="/core/api#webspace/listFirewallEntries">In
 * Reseller-Interface öffnen</a>
 */
class WebspaceListFirewallEntries extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/webspace/listFirewallEntries';
    }
}
