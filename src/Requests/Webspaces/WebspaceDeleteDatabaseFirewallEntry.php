...
/**
 * post_webspace_deleteDatabaseFirewallEntry
 *
 * Löscht eine Firewall-Freigabe für eine Webspace-Datenbank<br /><br />Benötigte Rechte:<br
 * />**Webspacepakete verwalten** (api.webspace.manage)<br /><br /><a target="_blank"
 * href="/core/api#webspace/deleteDatabaseFirewallEntry">In Reseller-Interface öffnen</a>
 */
class WebspaceDeleteDatabaseFirewallEntry extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return '/webspace/deleteDatabaseFirewallEntry';
    }
}
