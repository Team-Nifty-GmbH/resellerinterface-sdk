...
/**
 * post_webspace_listDatabases
 *
 * Listet vorhandene Datenbanken auf<br /><br />Benötigte Rechte:<br />**Webspacepakete einsehen**
 * (api.webspace.view)<br /><br /><a target="_blank" href="/core/api#webspace/listDatabases">In
 * Reseller-Interface öffnen</a>
 */
class WebspaceListDatabases extends Request implements HasBody
{
    use HasFormBody;
