...
/**
 * post_webspace_createBackup
 *
 * Erstellt ein Backup eines Webspaces<br /><br />Benötigte Rechte:<br />**Webspacepakete verwalten**
 * (api.webspace.manage)<br /><br /><a target="_blank" href="/core/api#webspace/createBackup">In
 * Reseller-Interface öffnen</a>
 */
class WebspaceCreateBackup extends Request implements HasBody
{
    use HasFormBody;
