...
/**
 * post_domainContent_get
 *
 * Fragt einen Content zu einer Domain ab<br /><br />Benötigte Rechte:<br />**Zonenrecords (RR)
 * verwalten** (api.dns.manageRecords)<br /><br /><a target="_blank"
 * href="/core/api#domainContent/get">In Reseller-Interface öffnen</a>
 */
class DomainContentGet extends Request implements HasBody
{
    use HasFormBody;
