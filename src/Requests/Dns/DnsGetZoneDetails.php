...
/**
 * post_dns_getZoneDetails
 *
 * Ruft eine Zone samt SOA und Records ab<br /><br />Benötigte Rechte:<br />**Zonen einsehen**
 * (api.dns.view)<br /><br /><a target="_blank" href="/core/api#dns/getZoneDetails">In
 * Reseller-Interface öffnen</a>
 */
class DnsGetZoneDetails extends Request implements HasBody
{
    use HasFormBody;
