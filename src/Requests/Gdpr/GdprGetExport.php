 ...
 * post_gdpr_getExport
 *
 * Ruft einen Datenschutzexport ab<br /><br />Benötigte Rechte:<br />**Eigene Resellerdaten
 * verwalten** (api.reseller.manageSelf)<br /><br /><a target="_blank"
 * href="/core/api#gdpr/getExport">In Reseller-Interface öffnen</a>
 */
class GdprGetExport extends Request implements HasBody
{
    use HasFormBody;
