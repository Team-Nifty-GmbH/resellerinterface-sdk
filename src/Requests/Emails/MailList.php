 ...
 * post_mail_list
 *
 * Listet E-Mail-Adressen auf<br /><br />Benötigte Rechte:<br />**E-Mail-Weiterleitungen anzeigen**
 * (api.email.view)<br /><br /><a target="_blank" href="/core/api#mail/list">In Reseller-Interface
 * öffnen</a>
 */
class MailList extends Request implements HasBody
{
    use HasFormBody;
