 ...
 *
 * Transferiert eine bestehende Domain<br /><br />Benötigte Rechte:<br />**Domains bestellen**
 * (api.domain.order)<br /><br /><a target="_blank" href="/core/api#domain/transfer">In
 * Reseller-Interface öffnen</a>
 */
class DomainTransfer extends Request implements HasBody
{
    use HasFormBody;
