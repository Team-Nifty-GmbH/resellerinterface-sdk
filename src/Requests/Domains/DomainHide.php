 ...
 * post_domain_hide
 *
 * Blendet eine nicht aktive Domain für die List-Funktion aus<br /><br />Benötigte Rechte:<br
 * />**Domains verwalten** (api.domain.manage)<br /><br /><a target="_blank"
 * href="/core/api#domain/hide">In Reseller-Interface öffnen</a>
 */
class DomainHide extends Request implements HasBody
{
    use HasFormBody;
