 ...
 * post_domain_renew
 *
 * Verlängert eine Domain<br /><br />Benötigte Rechte:<br />**Domains bestellen**
 * (api.domain.order)<br /><br /><a target="_blank" href="/core/api#domain/renew">In Reseller-Interface
 * öffnen</a>
 */
class DomainRenew extends Request implements HasBody
{
    use HasFormBody;
